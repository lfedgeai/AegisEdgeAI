...
const (
	...
	// FlagUnifiedIdentity enables the Unified Identity feature for Sovereign AI workloads.
	// This flag enables SPIRE API changes to support Proof of Residency (PoR) and Proof of Geofencing (PoG)
	// attestation flows with Keylime integration. When enabled, agents can send SovereignAttestation
	// data and servers will evaluate policy against AttestedClaims from Keylime.
