...
const file_spire_api_types_jwtsvid_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_spire_api_types_jwtsvid_proto_rawDescData []byte
)

func file_spire_api_types_jwtsvid_proto_rawDescGZIP() []byte {
	file_spire_api_types_jwtsvid_proto_rawDescOnce.Do(func() {
		file_spire_api_types_jwtsvid_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spire_api_types_jwtsvid_proto_rawDesc), len(file_spire_api_types_jwtsvid_proto_rawDesc)))
	})
...
var file_spire_api_types_jwtsvid_proto_goTypes = []any{
...
func file_spire_api_types_jwtsvid_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spire_api_types_jwtsvid_proto_rawDesc), len(file_spire_api_types_jwtsvid_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
