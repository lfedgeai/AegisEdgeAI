...
// Unified-Identity - Phase 1: SPIRE API & Policy Staging (Stubbed Keylime)
// Attested claims returned from Keylime and embedded in SVID responses.
...
// Unified-Identity - Phase 1: SPIRE API & Policy Staging (Stubbed Keylime)
// Added sovereign_attestation field to support PoR/PoG flows.
type X509SVIDRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unified-Identity - Phase 1: SPIRE API & Policy Staging (Stubbed Keylime)
	// Optional sovereign attestation data for Proof of Residency and Proof of Geofencing.
...
type X509SVIDResponse struct {
	...
	// Unified-Identity - Phase 1: SPIRE API & Policy Staging (Stubbed Keylime)
	// Attested claims from Keylime verification (geolocation, host integrity, GPU metrics).
