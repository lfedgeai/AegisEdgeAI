...
class TestTPMPlugin(unittest.TestCase):
    ...
    def test_generate_quote_stub(self):
        """Test removed - quote generation is now handled by rust-keylime agent"""
        # This test is intentionally skipped as quote generation was moved to rust-keylime agent
        import pytest
        pytest.skip("Quote generation removed from TPM plugin - handled by rust-keylime agent")
