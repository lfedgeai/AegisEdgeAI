...
echo ""
echo -e "${YELLOW}Action: Starting the SPIRE Agent...${NC}"
echo "Watch the logs. It is connecting to the Keylime Plugin..."
echo "verifying the GNSS sensor... and now it receives the SVID."
echo ""
