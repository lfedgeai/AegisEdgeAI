...
/// Unified-Identity: /delegated_certification is only registered if feature flag is enabled
...
/// Unified-Identity: unified_identity_enabled flag controls whether delegated certification endpoint is registered
