...
func (x *NewX509SVIDParams) GetSovereignAttestation() *types.SovereignAttestation {
	if x != nil {
...
func (x *BatchNewX509SVIDResponse_Result) GetAttestedClaims() []*types.AttestedClaims {
	if x != nil {
...
const file_spire_api_server_svid_v1_svid_proto_rawDesc = "" +
	"\n" +
	"#spire/api/server/svid/v1/svid.proto\x12\x18spire.api.server.svid.v1\x1a\x1dspire/api/types/jwtsvid.proto\x1a\x1espire/api/types/spiffeid.proto\x1a\x1cspire/api/types/status.proto\x1a\x1espire/api/types/x509svid.proto\x1a*spire/api/types/sovereignattestation.proto\"9\n" +
	...
	"\x06params\x18\x01 \x03(\v2+.spire.api.server.svid.v1.NewX509SVIDParamsR\x06params\"\xa4\x02\n" +
	"\x18BatchNewX509SVIDResponse\x12S\n" +
	"\aresults\x18\x01 \x03(\v29.spire.api.server.svid.v1.BatchNewX509SVIDResponse.ResultR\aresults\x1a\xb2\x01\n" +
	"\x06Result\x12/\n" +
	"\x06status\x18\x01 \x01(\v2\x17.spire.api.types.StatusR\x06status\x12-\n" +
	"\x04svid\x18\x02 \x01(\v2\x19.spire.api.types.X509SVIDR\x04svid\x12H\n" +
	"\x0fattested_claims\x18\x1e \x03(\v2\x1f.spire.api.types.AttestedClaimsR\x0eattestedClaims\"J\n" +
	...
	"\x10x509_authorities\x18\x02 \x03(\fR\x0fx509Authorities\"\x9c\x01\n" +
	"\x11NewX509SVIDParams\x12\x19\n" +
	"\bentry_id\x18\x01 \x01(\tR\aentryId\x12\x10\n" +
	"\x03csr\x18\x02 \x01(\fR\x03csr\x12Z\n" +
	"\x15sovereign_attestation\x18\x14 \x01(\v2%.spire.api.types.SovereignAttestationR\x14sovereignAttestation2\xca\x04\n" +
	"\x04SVID\x12m\n" +
...
var file_spire_api_server_svid_v1_svid_proto_goTypes = []any{
	...
	(*types.AttestedClaims)(nil),            // 17: spire.api.types.AttestedClaims
}
var file_spire_api_server_svid_v1_svid_proto_depIdxs = []int32{
	...
	15, // 6: spire.api.server.svid.v1.NewX509SVIDParams.sovereign_attestation:type_name -> spire.api.types.SovereignAttestation
	...
	17, // 9: spire.api.server.svid.v1.BatchNewX509SVIDResponse.Result.attested_claims:type_name -> spire.api.types.AttestedClaims
	0,  // 10: spire.api.server.svid.v1.SVID.MintX509SVID:input_type -> spire.api.server.svid.v1.MintX509SVIDRequest
	2,  // 11: spire.api.server.svid.v1.SVID.MintJWTSVID:input_type -> spire.api.server.svid.v1.MintJWTSVIDRequest
	4,  // 12: spire.api.server.svid.v1.SVID.BatchNewX509SVID:input_type -> spire.api.server.svid.v1.BatchNewX509SVIDRequest
	6,  // 13: spire.api.server.svid.v1.SVID.NewJWTSVID:input_type -> spire.api.server.svid.v1.NewJWTSVIDRequest
	8,  // 14: spire.api.server.svid.v1.SVID.NewDownstreamX509CA:input_type -> spire.api.server.svid.v1.NewDownstreamX509CARequest
	1,  // 15: spire.api.server.svid.v1.SVID.MintX509SVID:output_type -> spire.api.server.svid.v1.MintX509SVIDResponse
	3,  // 16: spire.api.server.svid.v1.SVID.MintJWTSVID:output_type -> spire.api.server.svid.v1.MintJWTSVIDResponse
	5,  // 17: spire.api.server.svid.v1.SVID.BatchNewX509SVID:output_type -> spire.api.server.svid.v1.BatchNewX509SVIDResponse
	7,  // 18: spire.api.server.svid.v1.SVID.NewJWTSVID:output_type -> spire.api.server.svid.v1.NewJWTSVIDResponse
	9,  // 19: spire.api.server.svid.v1.SVID.NewDownstreamX509CA:output_type -> spire.api.server.svid.v1.NewDownstreamX509CAResponse
