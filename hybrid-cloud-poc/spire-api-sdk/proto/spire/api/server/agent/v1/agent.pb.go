...
func (x *AgentX509SVIDParams) GetSovereignAttestation() *types.SovereignAttestation {
	if x != nil {
...
func (x *AttestAgentResponse_Result) GetAttestedClaims() []*types.AttestedClaims {
	if x != nil {
		return x.AttestedClaims
	}
	return nil
...
const file_spire_api_server_agent_v1_agent_proto_rawDesc = "" +
	...
	"\bagent_id\x18\x03 \x01(\v2\x19.spire.api.types.SPIFFEIDR\aagentId\"\x83\x01\n" +
	"\x13AgentX509SVIDParams\x12\x10\n" +
	"\x03csr\x18\x01 \x01(\fR\x03csr\x12Z\n" +
