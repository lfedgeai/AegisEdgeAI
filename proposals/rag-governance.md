...
**Cryptographic Binding:** The entire JSON artifact above is serialized and signed using the Private Key associated with the `principal`'s SPIFFE SVID. This creates a tamper-proof "Compliance Envelope" that proves:
