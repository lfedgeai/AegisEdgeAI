...
Here is the correctly formatted Markdown content for `docs/governence.md`. I have cleaned up the spacing, added syntax highlighting for the code blocks, and structured the headers to render perfectly on GitHub.
